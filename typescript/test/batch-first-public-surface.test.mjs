...
const REQUIRED_VALUE_EXPORTS = ["batchFirst", "BatchFirstIneligibleError"];

// Internal batch-adapter plumbing that must stay out of the package root —
// only the customer-facing batchFirst() entry point and its supporting
...
test("package root exports the customer-facing batchFirst values", () => {
