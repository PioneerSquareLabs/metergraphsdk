...
def test_all_declares_the_required_deferred_exports():
...
def test_deferred_does_not_accept_polling_or_clock_mechanics():
    params = inspect.signature(metergraph.deferred).parameters
