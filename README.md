...
wins). OpenInference instrumentors publish one scope per instrumented library,
named after it — `openinference.instrumentation.openai` and so on; the Langfuse
